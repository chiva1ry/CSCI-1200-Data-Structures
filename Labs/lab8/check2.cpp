...
//
//
//int numberPaths(int x, int y, const vector<vector<bool>>& blocked) {
//    if (x == 0 && y == 0) {
//        return 1;
//    } else if (blocked[x][y]) {
//        return 0;
//    } else if (y == 0 && x > 0) {
//        return numberPaths(x-1, y, blocked);
//    } else if (x == 0 && y > 0) {
//        return numberPaths(x, y-1, blocked);
//    }
//    return numberPaths(x-1, y, blocked) + numberPaths(x, y-1, blocked);
//}
//
//
//
