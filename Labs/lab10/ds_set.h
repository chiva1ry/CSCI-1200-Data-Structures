...
private:
    ...
    TreeNode<T>*  copy_tree(TreeNode<T>* old_root) {
        ...
        temp_root->right = old_root->right;
        temp_root->left = old_root->left;
        temp_root->value = old_root->value;
        
        
        copy_tree(temp_root->left);
        copy_tree(temp_root->right);
    ...
    iterator findrec(const T& key_value, TreeNode<T>* p) {
